      ...
      <div>
        {
          doctors.slice(0,3).map((doctor, index) => (
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
                ...
                <img src={doctor.image} alt={doctor.name} className='w-32 bg-indigo-50' />
                <div className='flex-1 text-sm text-zinc-600'>
                  ...
                  <p className='text-sm mt-1'><span className='text-sm text-neutral font-medium'>Date & Time:</span>25, July, 2024 | 8:30 PM</p>
                </div>
                <div></div>
              ...
              <p className='text-sm text-gray-500 mt-2'>Appointment Date: {new Date().toLocaleDateString()}</p>
            </div>
          ))
        }
      </div>
