...
const Navbar = () => {
    ...
    const [showMenu, setShowMenu] = useState(false);// false is default
    const [token, setToken] = useState(true);// true is default
            ...
            <div className='flex items-center gap-4'>
                {
                    ...
                    :
                    (<button onClick={() => navigate('/login')} className='bg-[var(--color-primary)] text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>)
                }
